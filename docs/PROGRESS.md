...
| US-051 — Trợ lý AI hỗ trợ soạn đơn tố giác tội phạm & Quét CCCD | P0 | Done | Full-stack | `lib/cccd-parser.ts`, `lib/complaint-form-state.ts`, `lib/docx-generator.ts`, `lib/legal-aid-interview.ts`, `app/api/legal-aid/interview/route.ts`, `components/CccdQrScanner.tsx`, `components/ComplaintDocumentPreview.tsx`, `components/SubmissionGuidanceModal.tsx`, `app/tro-giup-phap-ly/soan-don/page.tsx`, `app/tro-giup-phap-ly/page.tsx`; `tests/cccd-parser.test.mjs` 4/4, `tests/complaint-form-state.test.mjs` 2/2, `tests/docx-generator.test.mjs` 1/1, `tests/legal-aid-interview.test.mjs` 3/3, `tests/cccd-qr-scanner-ui.test.mjs` 1/1, `tests/complaint-document-preview-ui.test.mjs` 1/1, `tests/submission-guidance.test.mjs` 1/1, `tests/soan-don-page.test.mjs` 2/2 pass (15/15), full suite 558/558 pass, `tsc --noEmit` 0 lỗi (DEC-032) | 2026-09-13 |
